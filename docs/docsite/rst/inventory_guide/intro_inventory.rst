...
.. note:: If working with :ref:`inventory plugins<plugins/inventory>, implicit groups, such as ``all`` or ``ungrouped``, need to be explicitly defined in an inventory to apply the corresponding group_vars.
